   ...
   implements TreeSelectionListener
{
   ...
   //--------------------------------------
      ...
      for (int i=0; i<5; i++) 
         salesMgr .add(new Employee("Sales "+new Integer(i).toString(), 30000 +(long)((Math.random()-0.5)*10000)));
      ...
      for (int i = 0; i < 4; i++)
        prodMgr.add( new Employee("Manuf "+new Integer(i).toString(), 25000 +(long)((Math.random()-0.5)*5000)));
      for (int i = 0; i < 3; i++)
        shipMgr.add( new Employee("ShipClrk "+new Integer(i).toString(), 20000 +(long)((Math.random()-0.5)*5000)));
